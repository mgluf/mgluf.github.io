...
!function (d) {
  ...
  var moving = true;
  var timer;
  var isAutoScroll = document.getElementsByClassName('auto-scroll'); // To initialise the carousel we'll want to update the DOM with our own classes
  ...
  function setInitialClasses() {
    ...
    if (isAutoScroll.length > 0) {
      // Init timer for auto-scroll if class is present
      startTimer();
    }
  }

  function startTimer() {
    timer = setInterval(moveNext, 8000);
